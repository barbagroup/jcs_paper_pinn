...
The suspicion of spectral bias prompted us to conduct spectral analysis using Koopman analysis, which is presented in section \ref{sec:cylinder-re200-koopman}.
