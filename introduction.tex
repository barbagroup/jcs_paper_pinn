...
Our PINN solvers were built using the NVIDIA \emph{Modulus} toolkit, a high-level package built on PyTorch for building, training, and fine-tuning physics-informed machine learning models.
